defmodule Ast.FootnotesTest do
  use ExUnit.Case
  ...
  # describe "Footnotes" do
    ...
    test "without errors" do
      ...
      ast = [{"p", [],  ["foo",   {"a",    [{"class", "footnote"}, {"href", "#fn:1"}, {"id", "fnref:1"}, {"title", "see footnote"}], ["1"]}, " again"]}, {"div", [{"class", "footnotes"}],  [{"hr", [], []},   {"ol", [],    [{"li", [{"id", "fn:1"}],      [{"p", [],        ["bar baz&nbsp;",         {"a",          [{"class", "reversefootnote"},{"href", "#fnref:1"}, {"title", "return to article"}], ["&#x21A9;"]}]}]}]}]}]
      messages = []
