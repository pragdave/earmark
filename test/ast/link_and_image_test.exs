defmodule Ast.LinkAndImgTest do
  ...
  describe "Link reference definitions" do
    ...
    test "img with title" do
      ...
      ast = {"p", [], [{"img", [{"alt", "foo"}, {"src", "/url"}, {"title", "title"}], []}]}
      messages = []
  ...
  describe "Link and Image imbrication" do
    ...
    test "as with this img" do
      ...
      ast = {"p", [], [{"img", [{"alt", "[text](inner)"}, {"src", "outer"}], []}]}
      messages = []
    ...
    test "headaches ahead (and behind us)" do
      ...
      ast = {"p", [], [{"a", [{"href", "/uri"}], [{"img", [{"alt", "moon"}, {"src", "moon.jpg"}], []}]}]}
      messages = []
    ...
    test "lost in space" do
      ...
      ast = {"p", [], [{"img", [{"alt", "![moon](moon.jpg)"}, {"src", "sun.jpg"}], []}]}
      messages = []
      assert as_ast(markdown) == {:ok, ast, messages}
    end
  end
  ...
  describe "Links" do
    ...
    test "titled link, with depreacted quote mismatch" do
      markdown = "[link](/uri \"title')\n"
      # html     = "<p><a href=\"/uri\" title=\"title\">link</a></p>\n"
      ast = {"p", [], [{"a", [{"href", "/uri"}, {"title", "title"}], ["link"]}]}
  ...
  describe "Images" do
    ...
    test "ti tle (why not)" do
      ...
      ast = {"p", [], [{"img", [{"alt", "foo"}, {"src", "/url"}, {"title", "ti tle"}], []}]}
      messages = []
    ...
    test "as does everything else" do
      ...
      ast = {"p", [], [{"img", [{"alt", "f[]oo"}, {"src", "/url"}, {"title", "ti() tle"}], []}]}
      messages = []
    ...
    test "url escapes of course" do
      ...
      ast = {"p", [], [{"img", [{"alt", "foo"}, {"src", "/url%20no%20title"}], []}]}
      messages = []
