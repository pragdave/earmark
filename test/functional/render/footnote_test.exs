defmodule FootnoteTest do
  ...
  test "uses a starting footnote number" do
    ...
    { blocks, footnotes, _ } = Parser.handle_footnotes(text, opts, &map3/3)
  ...
  test "parses footnote content" do
    ...
    {blocks, footnotes, _} = Parser.handle_footnotes(blocks, options(), &map3/3)
  ...
  defp map3 coll, fun, _ignored do
    Enum.map(coll, fun)
  end
end
