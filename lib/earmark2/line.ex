defmodule Earmark2.Line do
  ...
  defmodule Blank,        do: defstruct lnb: 0, line: "", tokens: [], content: "", inside_code: false
  defmodule Ruler,        do: defstruct lnb: 0, line: "", tokens: [], type: "- or * or _", inside_code: false
  defmodule Heading,      do: defstruct lnb: 0, line: "", tokens: [], level: 1, content: "inline text", inside_code: false
  defmodule BlockQuote,   do: defstruct lnb: 0, line: "", tokens: [], content: "text", inside_code: false
  defmodule Indent,       do: defstruct lnb: 0, line: "", tokens: [], level: 0, content: "text", inside_code: false
  defmodule Fence,        do: defstruct lnb: 0, line: "", tokens: [], delimiter: "~ or `", language: nil , inside_code: false
  defmodule HtmlOpenTag,  do: defstruct lnb: 0, line: "", tokens: [], tag: "", content: "", inside_code: false
  defmodule HtmlCloseTag, do: defstruct lnb: 0, line: "", tokens: [], tag: "<... to eol", inside_code: false
  defmodule HtmlComment,  do: defstruct lnb: 0, line: "", tokens: [], complete: true, inside_code: false
  defmodule HtmlOneLine,  do: defstruct lnb: 0, line: "", tokens: [], tag: "", content: "", inside_code: false
  defmodule IdDef,        do: defstruct lnb: 0, line: "", tokens: [], id: nil, url: nil, title: nil, inside_code: false
  defmodule FnDef,        do: defstruct lnb: 0, line: "", tokens: [], id: nil, content: "text", inside_code: false
  defmodule ListItem,     do: defstruct lnb: 0, type: :ul, line: "", tokens: [],
                                        bullet: "* or -", content: "text",
                                        initial_indent: 0, inside_code: false
  defmodule SetextUnderlineHeading,
                          do: defstruct lnb: 0, line: "", tokens: [], level: 1, inside_code: false, inside_code: false
  defmodule TableLine,    do: defstruct lnb: 0, line: "", tokens: [], content: "", columns: 0, inside_code: false
  defmodule Ial,          do: defstruct lnb: 0, line: "", tokens: [], attrs:   "", inside_code: false, verbatim: ""
  defmodule Text,         do: defstruct lnb: 0, line: "", tokens: [], content: "", inside_code: false

  defmodule Plugin,       do: defstruct lnb: 0, line: "", tokens: [], content: "", prefix: "$$"
  ...
  def scan_lines( lines, options \\ %Options{}) do
    lines
    |> Enum.zip(Stream.iterate(1, &(&1+1)))
    |> Earmark.pmap(&scan_line/1, options.timeout || 5000)
    |> scan_recursively([], 0, options)
  end

  defp scan_recursively(lines, result, level, options)
  defp scan_recursively([], result, _, options), do: {Enum.reverse(result), options}
  defp scan_recursively([{lnb, []}|ls], result, level, options) do
     scan_recursively(ls, [%Blank{lnb: lnb} | result], level, options)
  end
  defp scan_recursively([{lnb, [{:st_indent, spaces, _}]}|ls]=ts, result, level, options) do
     scan_recursively(ls, [%Blank{lnb: lnb, content: spaces, tokens: ts} | result], level, options)
  end
