defmodule Earmark.Helpers.LookaheadHelpers do
  ...
  *without* opening a new one.
  ...
  defp has_still_opening_backtix([{:verbatim, _} | rest], opened_so_far),
  ...
  @spec read_list_lines(Line.ts(), inline_code_continuation, number) ::
          {boolean, Line.ts(), Line.ts(), number, number}
  @doc """
  ...
  @spec _read_list_lines(Line.ts(), Line.ts(), read_list_info) ::
          {boolean, Line.ts(), Line.ts(), number}
