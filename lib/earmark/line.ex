defmodule Earmark.Line do
  ...
  defmodule(
    Indent,
    do: defstruct(lnb: 0, line: "", level: 0, content: "text", inside_code: false)
  )
  ...
  defmodule(
    HtmlOpenTag,
    do: defstruct(lnb: 0, line: "", tag: "", content: "", inside_code: false)
  )
  ...
  def type_of(line, recursive)
      ...
      do: type_of(line, %Earmark.Options{}, recursive)
